...
SOCIAL_AUTH_GOOGLE_OAUTH2_REDIRECT_URIS = [
    'https://smartbus-4b8558a1299d.herokuapp.com/social-auth/complete/google-oauth2/',
]
...
SOCIAL_AUTH_PIPELINE = (
    ...
    'path.to.your.create_customer',  # Thêm khách hàng sau khi tạo User
